...
\begin{figure}[tbp]
	\centerline{\includegraphics[scale=0.25]{Img/Acquisition.jpg}}
...
\begin{figure}[tbp]
	\centerline{\includegraphics[scale=0.5]{Img/Sardinia.jpg}}
...
\begin{figure}[!t]
	\centerline{\includegraphics[scale=0.37]{Img/Fig1.pdf}}
...
\begin{figure}[tbp]
	\centering
	\includegraphics[scale=0.6]{Img/SardiniaMasks.jpg}
...
\begin{figure}[tbp]
	\centering
	\includegraphics[scale=0.4]{Img/Sardinia_crops.jpg}
...
\begin{figure}[htbp]
\centering
\includegraphics[height=0.35\textheight]{Img/f3_features_selection.jpg}
